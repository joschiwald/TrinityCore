...
class SmartScript
{
    public:
        ...
        void OnInitialize(WorldObject* obj);
        void OnInitialize(SmartScriptType type, WorldObject* obj, uint32 entry);
        void GetScript();
        void FillScript(SmartAIEventList e, WorldObject* obj, uint32 entry = 0);
