                ...
                switch (id)
                {
                    ...
                    case POINT_TABLE:
                        ...
                        switch (_phase)
                        {
                            case PHASE_COMBAT_2:
                            {
                                SpellInfo const* spell = sSpellMgr->GetSpellInfo(SPELL_CREATE_CONCOCTION, me);
                            ...
                            case PHASE_COMBAT_3:
                            {
                                SpellInfo const* spell = sSpellMgr->GetSpellInfo(SPELL_GUZZLE_POTIONS, me);
    ...
    public:
        ...
        class spell_putricide_mutated_plague_AuraScript : public AuraScript
        {
            ...
            void HandleTriggerSpell(AuraEffect const* aurEff)
            {
                ...
                SpellInfo const* spell = sSpellMgr->AssertSpellInfo(triggerSpell, GetTarget());
            ...
            void OnRemove(AuraEffect const* /*aurEff*/, AuraEffectHandleModes /*mode*/)
            {
                ...
                SpellInfo const* healSpellInfo = sSpellMgr->GetSpellInfo(healSpell, GetTarget());
