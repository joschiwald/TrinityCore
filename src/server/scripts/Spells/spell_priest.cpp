    ...
    public:
        ...
        class spell_pri_glyph_of_prayer_of_healing_AuraScript : public AuraScript
        {
            ...
            void HandleProc(AuraEffect const* aurEff, ProcEventInfo& eventInfo)
            {
                ...
                SpellInfo const* triggeredSpellInfo = sSpellMgr->AssertSpellInfo(SPELL_PRIEST_GLYPH_OF_PRAYER_OF_HEALING_HEAL, GetSpellInfo()->DifficultyId);
    ...
    public:
        ...
        class spell_pri_leap_of_faith_effect_trigger_SpellScript : public SpellScript
        {
            ...
            void HandleEffectDummy(SpellEffIndex /*effIndex*/)
            {
                ...
                GetHitUnit()->CastSpell(targets, sSpellMgr->GetSpellInfo(GetEffectValue(), GetHitUnit()), nullptr);
            }
    ...
    public:
        ...
        class spell_pri_t10_heal_2p_bonus_AuraScript : public AuraScript
        {
            ...
            void HandleProc(AuraEffect const* aurEff, ProcEventInfo& eventInfo)
            {
                ...
                SpellInfo const* spellInfo = sSpellMgr->AssertSpellInfo(SPELL_PRIEST_BLESSED_HEALING, caster);
        ...
        class spell_pri_angelic_feather_trigger_SpellScript : public SpellScript
        {
            ...
            void HandleEffectDummy(SpellEffIndex /*effIndex*/)
            {
                ...
                else
                {
                    SpellCastTargets targets;
                    targets.SetDst(destPos);
                    GetCaster()->CastSpell(targets, sSpellMgr->GetSpellInfo(SPELL_PRIEST_ANGELIC_FEATHER_AREATRIGGER, GetCaster()), nullptr);
                }
            }
